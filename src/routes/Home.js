...
const Home = () => {
  ...
  return (
    <div className="flex w-full h-screen">
      <nav className="bg-teal-400 w-[20%] flex flex-col gap-12">
        <p className="h-[8rem] bg-yellow-200">LOGO</p>
        <div className="flex flex-col">
          <Link to="animals" className="group cursor-pointer hover:bg-teal-300 p-4">
          ...
          <Link to="vets" className="group cursor-pointer hover:bg-teal-300 p-4">
            <li className="list-none flex flex-row gap-2 justify-content items-center">
          ...
          <Link to="appointments" className="group cursor-pointer hover:bg-teal-300 p-4">
            <li className="list-none flex flex-row gap-2 justify-content items-center">
          ...
          <Link to="/new_appointment" className="group cursor-pointer hover:bg-teal-300 p-4">
            <li className="list-none flex flex-row gap-2 justify-content items-center">
          ...
          <li
            className="list-none flex flex-row gap-2 justify-content items-center mt-[1rem] group cursor-pointer hover:bg-teal-300 p-4"
